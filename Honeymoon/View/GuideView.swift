    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .center, spacing: 20) {
                ...
                Text("Discover and pick the perfect destination for your romantic Honeymoons")
                    .lineLimit(nil)
                ...
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymoons resorts is perfect setting for you to embark your new life together", icon: "checkmark.square")
                }
